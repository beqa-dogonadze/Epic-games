...
const SignIn = () => {
  ...
  let disabledbtn =
    'mt-10 p-4 rounded-md text-gray-400 text-sm -bold w-[370px] h-[60px] bg-[#114b82]'
  ...
  return (
    <div className='w-[400px] lg:w-[480px] h-[750px] lg:h-[800px] bg-[#202020] m-auto flex flex-col justify-center items-center mt-20 rounded'>
      <div className='flex flex-col items-center'>
        ...
        {email ? (
          <input
            className='mt-5 bg-[#202020] text-white border-[1px] border-gray-600 pt-7 p-4 rounded-md w-[370px] h-[60px]'
            type='email'
            id='email'
            value={email}
          ...
          <input
            className='mt-5 bg-[#202020] text-white border-[1px] border-gray-600 p-4 rounded-md w-[370px] h-[60px]'
            type='email'
            id='email'
            value={email}
            onChange={onEmailChange}
        ...
        {email ? (
          <h1 className='absolute text-[13px] mr-3 text-gray-300 pr-[243px] mt-[164px]'>
            Email address
          </h1>
        ) : null}
        <h1
        ...
        <div class='flex items-center justify-center'>
          <hr class='w-[360px] h-px my-8 bg-gray-200 border-0 dark:bg-gray-700' />
      ...
      <div className='flex justify-between items-center flex-wrap mt-5 gap-1 h-[140px] w-[360px]'>
        <LogInOptions />
      </div>
      <h1 className='text-gray-300 mt-10 w-[360px] text-sm text-center'>
